 ...
 * 
 * Adding K-Anonymity and SHA-1 Hashing:
 ...
 * 
 * Adding Authentiction / paid API keys for searching Usernames:
  ...
  https.get(options, (response) => {
    if (response.statusCode == 200) {
      ...
      response.on('end', () => {        
        ...
        // If count is 0, this will be false and it'll go to the else condition:
        if (count) {
